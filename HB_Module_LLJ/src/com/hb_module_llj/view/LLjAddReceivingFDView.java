...
public class LLjAddReceivingFDView extends BaseDialogFragmentView {
	...
	public void preInit(Map<String, Object> params) {
		...
		this.viewName = LLjAddReceivingFDView.class.getSimpleName();
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		this.ssContentView = inflater.inflate(R.layout.page_llj_add_receive_ly,
				null);
		initView();
		initListener();
		...
		this.backView.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				Engine.viewManager.getDialogViewFromCache(
						LLjAddReceivingFDView.class.getSimpleName()).dismiss();
