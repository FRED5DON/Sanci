...
public class LLjRegisterFDView extends BaseDialogFragmentView {
	...
	private EditText pwdETxt;
	private EditText rePwdETxt;


	public LLjRegisterFDView() {
		super();
	}
	...
	public void preInit(Map<String, Object> params) {
		...
		this.viewName = LLjRegisterFDView.class.getSimpleName();
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		this.ssContentView = inflater.inflate(R.layout.page_llj_compelet_pwd_ly,
				null);
		initView();
		initListener();
	...
	private void initView() {
		...
		this.sureBtn = this.ssContentView.findViewById(R.id.ljj_sure_btn);
		
		this.pwdETxt = (EditText)this.ssContentView.findViewById(R.id.llj_login_pwd_txt);
		
		this.rePwdETxt = (EditText)this.ssContentView.findViewById(R.id.llj_re_pwd_txt);
	...
	private void initListener() {
		this.backView.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				Engine.viewManager.getDialogViewFromCache(
						LLjRegisterFDView.class.getSimpleName()).dismiss();
		...
		sureBtn.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) {
				VCLLJGiftBus.getInstanceBus().LLjregister(pwdETxt.getText().toString(), rePwdETxt.getText().toString());
