...
public class LLjPolitenessFDView extends BaseDialogFragmentView {
	...
	public void preInit(Map<String, Object> params) {
		...
		this.viewName = LLjPolitenessFDView.class.getSimpleName();
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		this.ssContentView = inflater.inflate(R.layout.page_llj_politeness_ly,
				null);
		initView();
		initListener();
		...
		this.backView.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				Engine.viewManager.getDialogViewFromCache(
						LLjPolitenessFDView.class.getSimpleName()).dismiss();
